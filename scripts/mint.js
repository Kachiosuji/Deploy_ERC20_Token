 ...
 async function main() {
    const replace_contractAddress = "0x7016aD94e4Ac6968BCF4b1036F3b4c0241A59f7a";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("HardHatTest");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0x9aEbb91A6F788a41EeF5B28AC34e847aBefC1E75","100000000000000000000"]; // 100 tokens with 18 decimal places
